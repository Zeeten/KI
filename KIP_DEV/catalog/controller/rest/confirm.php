<?php 
class ControllerRestConfirm extends Controller { 
	/*
		Confirm order
	*/
	public function confirmOrder() {
		...
		$this->session->data['payment_method'] = 'Free Checkout';
		$this->session->data['payment_code'] = 'citrus';
		echo " in payment method ".$this->session->data['payment_method'];
		...
		foreach ($products as $product) {
			...
			if ($product['minimum'] > $product_total) {
				$json["error"]		= "Product minimum > product total";
				$json["success"]	= false;					
				break;
			}				
		}
