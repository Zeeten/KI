...
class ControllerRestCart extends Controller {
    ...
    */
    ...
    /*
    * @makai, need to implement, (don't user)
    */
    ...
    */
    public function shipping(){
        ...
        if ( $_SERVER['REQUEST_METHOD'] === 'POST' ){
            ...
            if (isset($post["shipping_method"]) && $this->validateShipping($post["shipping_method"])) {
                $this->session->data['shipping_method'] = $this->session->data['shipping_methods'][$shipping[0]]['quote'][$shipping[1]];
                $json['message'] = $this->language->get('text_shipping');
            } else {
                $json['error'] 	= $this->error;
                $json['success'] 	= false;
            }
	...
	*/
    ...
    private function addItemCart($data) {
        ...
        if ($product_info) {
            ...
            if ($json['success']) {
                $this->cart->add($data['product_id'], $quantity, $option,0);
